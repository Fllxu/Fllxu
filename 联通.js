...
class 哇哈哈_0xad71c {
  ...
  async login() {
    let _0x1f6477 = $.getFormattedDate(),
        _0x24d345 = $.DecryptCrypto("0", "AES", "CBC", "Pkcs7", "{\"phone\":\"" + $.DecryptCrypto("0", "AES", "CBC", "Pkcs7", this.phone, "woreadst^&*12345", "16-Bytes--String") + "\",\"timestamp\":\"" + _0x1f6477 + "\"}", "woreadst^&*12345", "16-Bytes--String"),
        _0x1dadc6 = {
...
async getAes2(e) {
    var t = "woreadst^&*12345",
    n = CryptoJS.enc.Utf8.parse("gnirtS--setyB-61".split("").reverse().join(""));
    t = CryptoJS.enc.Utf8.parse(t);
    var i = CryptoJS.enc.Utf8.parse(e);
    if (t) {
      var o = CryptoJS.AES.encrypt(i, t, {
      iv: n,
      mode: CryptoJS.mode.CBC,
      padding: CryptoJS.pad.Pkcs7
    }).ciphertext.toString();
    var words = CryptoJS.enc.Utf8.parse(o);
